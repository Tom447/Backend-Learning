  ...
  <div class="app-container">
    ...
    <el-form :inline="true" :model="searchStudent" class="demo-form-inline">
      <el-form-item label="姓名">
        <el-input v-model="searchStudent.name" placeholder="请输入班级名称"></el-input>
      </el-form-item>
      <el-form-item label="学号">
        <el-input v-model="searchStudent.no" placeholder="请输入学号"></el-input>
      </el-form-item>
      ...
      <el-form-item label="所属班级">
        <el-select v-model="searchStudent.clazzId" placeholder="请选择" style="width:100%">
    ...
    <!--编辑学生对话框表单-->
    <el-dialog ref="form" title="编辑学生" :visible.sync="updateDialogVisible" width="30%">
    ...
    <el-row>
      ...
      <el-button type="primary" size="medium" @click="add">+ 新增员工</el-button>
    </el-row>
...
export default {
  ...
  methods: {
    ...
    clear() {
      this.searchStudent = {name:"", no:"", degree:"", clazzId:""};
      this.page();
    },
    add() {
    ...
    getClazzList() {
      findAll().then(res => {
        if (res.data.code == 1) {
          ...
          console.log("clazzMap", clazzMap);
          this.clazzList = Array.from(clazzMap.values());
          console.log("clazzList", this.clazzList)
        } else {
          console.warn('查询学生数据失败', res.data.msg);
        }
      }).catch(error => {
